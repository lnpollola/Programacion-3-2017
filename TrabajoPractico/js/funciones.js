...
{
    var paginaValid = "http://localhost:8080/Programacion-3-2017/TrabajoPractico/index.php/validarusuario";
  ...
  //PRIMER AJAX ENCAPSULA USUARIO /validarusuario
  $.ajax({
        type: 'GET',
        url: paginaValid,
        dataType: "json",
		...
		if(data.validacion == 'ok')
		{
			...
			var paginaTipoEmp = "http://localhost:8080/Programacion-3-2017/TrabajoPractico/index.php/tipoempleado";
			var usuarioTipo = {};
...
{
    var paginaValid = "http://localhost:8080/Programacion-3-2017/TrabajoPractico/index.php/ingresarvehiculo/";
